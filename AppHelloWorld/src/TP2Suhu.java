 ...
 * @author straight
 */
public class TP2Suhu extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TP2Suhu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
